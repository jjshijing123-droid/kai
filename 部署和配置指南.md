...
# 设置变量
PROJECT_DIR="/var/www/ice-product-viewer"
BACKUP_DIR="/var/backups/ice-product-viewer"
NODE_VERSION="18"
...
module.exports = {
  apps: [{
    name: 'ice-product-viewer',
    script: 'server.js',
    cwd: '/var/www/ice-product-viewer',
    instances: 'max',
    exec_mode: 'cluster',
    env: {
      NODE_ENV: 'production',
    ...
    log_file: '/var/log/pm2/ice-product-viewer.log',
    out_file: '/var/log/pm2/ice-product-viewer-out.log',
    error_file: '/var/log/pm2/ice-product-viewer-error.log',
    time: true,
