...
// 正则表达式匹配翻译函数调用 t('key') 或 t("key")，只匹配包含下划线的键
// 真正的翻译键通常是由组件名或功能名加下划线组成的，比如 productManagement_refresh
const translationRegex = /t\(['"]([a-zA-Z0-9_]+)['"]/g;
...
fs.writeFileSync('translation_check_result_improved.json', JSON.stringify(result, null, 2), 'utf8');
console.log('结果已保存到 translation_check_result_improved.json');
